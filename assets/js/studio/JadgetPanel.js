class JadgetPanel{
  constructor(){
      this.basicSetup = () => function_BasicSetup;
      this.setupColorPicker = () => function_setupColorPicker;
      this.textToColorPickerColor = () => function_textToColorPickerColor;
      this.setupRotate = () => function_setupRotate;
      this.setupScale = () => function_setupScale;
      this.setupSkew = () => function_setupSkew;
      this.setupSteps = () => function_setupSteps;
