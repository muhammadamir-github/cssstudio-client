class Animator{
    ...
    setup(element){
        ...
        createanimationbutton.addEventListener('click',function(){
            self.animationActions('switch-custom','',element);
        ...
        playanimation.addEventListener('click',function(){
            self.animationActions('play','',element);
        });
        ...
        switchtoreadymadeanimation.addEventListener('click',function(){
            self.animationActions('switch-readymade','',element);
        ...
        if(Globals.pageHandler.data.plan !== 'Free'){
            if(Globals.pageHandler.data.plan == 'Gold' || Globals.pageHandler.data.plan == 'Diamond'){
                ...
                for(var i = 1; i < Globals.pageHandler.animations.length; i++){
                    ...
                    self.applyanimation(animations[i].name,element);
            }
    ...
    setupSlideOptions(element){
        ...
        opacity_customedit.addEventListener('keyup',function(){
            ...
            self.dataAttributeBalancer('slideOpacity',this.value);
        });
